...
func newFakeAlerts(alerts []*types.Alert, withErr bool) *fakeAlerts {
	...
	f := &fakeAlerts{alerts: alerts, fps: fps}
	if withErr {
...
func TestAddAlerts(t *testing.T) {
	...
	for i, tc := range []struct {
		...
		err		bool
		code		int
	}{{time.Time{}, time.Time{}, false, 200}, {now(0), time.Time{}, false, 200}, {time.Time{}, now(-1), false, 200}, {time.Time{}, now(0), false, 200}, {time.Time{}, now(1), false, 200}, {now(-2), now(-1), false, 200}, {now(1), now(2), false, 200}, {now(1), now(0), false, 400}, {now(0), time.Time{}, true, 500}} {
		alerts := []model.Alert{{StartsAt: tc.start, EndsAt: tc.end, Labels: model.LabelSet{"label1": "test1"}, Annotations: model.LabelSet{"annotation1": "some text"}}}
...
func TestAlertFiltering(t *testing.T) {
	...
	tests := []test{{&model.Alert{Labels: model.LabelSet{"label1": "test1"}}, "label1=test1", true}, {&model.Alert{Labels: model.LabelSet{"label1": "test2"}}, "label1=test2", false}, {&model.Alert{Labels: model.LabelSet{"label2": "test2"}}, "label2=test2", false}}
	...
	tests = []test{{&model.Alert{Labels: model.LabelSet{"label1": "test1"}}, "label1!=test1", false}, {&model.Alert{Labels: model.LabelSet{"label1": "test2"}}, "label1!=test2", true}, {&model.Alert{Labels: model.LabelSet{"label2": "test2"}}, "label2!=test2", true}}
	for _, test := range tests {
	...
	tests = []test{{&model.Alert{Labels: model.LabelSet{"label1": "test1"}}, "label1=~test1", true}, {&model.Alert{Labels: model.LabelSet{"label1": "test2"}}, "label1=~test2", true}, {&model.Alert{Labels: model.LabelSet{"label2": "test2"}}, "label2=~test2", false}}
	for _, test := range tests {
	...
	tests = []test{{&model.Alert{Labels: model.LabelSet{"label1": "test1"}}, "label1!~test1", false}, {&model.Alert{Labels: model.LabelSet{"label1": "test2"}}, "label1!~test2", false}, {&model.Alert{Labels: model.LabelSet{"label2": "test2"}}, "label2!~test2", true}}
	for _, test := range tests {
...
func TestSilenceFiltering(t *testing.T) {
	...
	tests := []test{{&types.Silence{Matchers: newMatcher(model.LabelSet{"label1": "test1"})}, "label1=test1", true}, {&types.Silence{Matchers: newMatcher(model.LabelSet{"label1": "test2"})}, "label1=test2", false}, {&types.Silence{Matchers: newMatcher(model.LabelSet{"label2": "test2"})}, "label2=test2", false}}
	for _, test := range tests {
	...
	tests = []test{{&types.Silence{Matchers: newMatcher(model.LabelSet{"label1": "test1"})}, "label1!=test1", false}, {&types.Silence{Matchers: newMatcher(model.LabelSet{"label1": "test2"})}, "label1!=test2", true}, {&types.Silence{Matchers: newMatcher(model.LabelSet{"label2": "test2"})}, "label2!=test2", true}}
	for _, test := range tests {
	...
	tests = []test{{&types.Silence{Matchers: newMatcher(model.LabelSet{"label1": "test1"})}, "label1=~test1", true}, {&types.Silence{Matchers: newMatcher(model.LabelSet{"label1": "test2"})}, "label1=~test2", true}, {&types.Silence{Matchers: newMatcher(model.LabelSet{"label2": "test2"})}, "label2=~test2", false}}
	for _, test := range tests {
	...
	tests = []test{{&types.Silence{Matchers: newMatcher(model.LabelSet{"label1": "test1"})}, "label1!~test1", false}, {&types.Silence{Matchers: newMatcher(model.LabelSet{"label1": "test2"})}, "label1!~test2", false}, {&types.Silence{Matchers: newMatcher(model.LabelSet{"label2": "test2"})}, "label2!~test2", true}}
	for _, test := range tests {
...
func TestMatchFilterLabels(t *testing.T) {
	...
	testCases := []struct {
		...
		expected	bool
	}{{labels.MatchEqual, true}, {labels.MatchRegexp, true}, {labels.MatchNotEqual, false}, {labels.MatchNotRegexp, false}}
	for _, tc := range testCases {
		l, err := labels.NewMatcher(tc.matcher, "foo", "")
		require.NoError(t, err)
		sms := map[string]string{"baz": "bar"}
		ls := []*labels.Matcher{l}
		require.Equal(t, tc.expected, matchFilterLabels(ls, sms))
		l, err = labels.NewMatcher(tc.matcher, "foo", "")
		require.NoError(t, err)
		sms = map[string]string{"baz": "bar", "foo": "quux"}
		ls = []*labels.Matcher{l}
